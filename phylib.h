...
/* Finally, the table (include this in your .h file) */
typedef struct {
    double time;
...
//void handle_collision(phylib_object **a, phylib_object *b);
...
//void phylib_print_table(phylib_object *object);
